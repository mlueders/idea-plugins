...
public abstract class CreateAndExecuteRunnerConfigurationAction extends AnAction {
    ...
    public void actionPerformed(AnActionEvent e) {
        LauncherComponent launcherComponent = LauncherComponent.get(e.getProject());
        RunnerAndConfigurationSettings configuration =
                launcherComponent.createRunnerConfigurationFromContextAndMakeActive(e.getDataContext());
        ProgramRunnerUtil.executeConfiguration(e.getProject(), configuration, executor);
    }
